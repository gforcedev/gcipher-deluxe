...
local ciphers = {}
ciphers.caesar = require("caesarCipher")
ciphers.monoSub = require("monoalphabeticSubstitutionCipher")
...
-- print(ciphers.caesar.crack(utils, ct))
print(ciphers.monoSub.crack(utils, ct))